                ...
                <div class="container-fluid">
                  <div class="row mb-2">
                    <div class="col-sm-6">
                      ...
                      <h1 class="m-0 text-dark"> Shawarma </h1>
                    </div><!-- /.col -->
                                ...
                                <table class="table table-striped"> <!-- table start -->
                                       ...
                                       <tbody>
                                        ...
                                        <th scope="row" style="padding-top: 50px;">1</th>
                                              <td>
                                                <div class="admin_item_img">
                                                  <img src="<?php echo base_url('assets/media/b3.jpg');?>" style="width:0100px;border-radius: 50%;object-fit: cover;">
                                        ...
                                        <th scope="row" style="padding-top: 50px;">2</th>
                                              <td>
                                                <div class="admin_item_img">
                                                  <img src="<?php echo base_url('assets/media/shawarma.jpg');?>" style="width:0100px;border-radius: 50%;object-fit: cover;">
                                                </div>
                                              </td>
                                              <td style="padding-top: 50px;">Zinger Burger</td>
                                        ...
                                        <th scope="row" style="padding-top: 50px;">1</th>
                                              <td>
                                                <div class="admin_item_img">
                                                  <img src="<?php echo base_url('assets/media/shawarma1.jpg');?>" style="width:0100px;border-radius: 50%;object-fit: cover;">
                                                </div>
                                              </td>
                                              <td style="padding-top: 50px;">Zinger Burger</td>
                                              <td style="padding-top: 50px;">180`</td>
