...
<div class="content-wrapper"> <!-- Content Header (Page header) -->
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Gallery_edit </h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>   <!-- /.content-header -->
  <section class="content"><!-- section class content start -->
  	<div class="container-fluid">
  	  <div class="rows">
  	  	<div class="col-md-6">
  	  		 <form method="post"action="<?php echo site_url();?>/admin/Gallary_c/gallary_edit_do">
             ...
             <div class="form-group">
              ...
              <input type="hidden" name="gallery_id" value="<?php echo $edit_data[0]->gallery_id; ?>">  
           </form> 
  	  	</div>
  	  </div>
  	</div>
