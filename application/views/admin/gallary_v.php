...
<div class="content-wrapper"> <!-- Content wrapper-->
   ...
   <section class="content"> <!-- section content start -->
   	<div class="container-fluid">
   		<div class="row">
   			<div class="col-md-4">
   			 <form method="post" action="<?php echo site_url('admin/Gallary_c/add_data');?>" enctype="multipart/form-data">
            ...
            //echo"<pre>";
              ...
              <tr>
                ...
                <td>
                  <?php
                        ...
                        ?>
                          ...
                          <a href="<?php echo site_url('admin/Gallary_c/block/0/'.$value->gallery_id); ?>" class="btn btn-sm btn-danger">
                        ...
                        ?>
                          ...
                          <a href="<?php echo site_url('admin/Gallary_c/block/1/'.$value->gallery_id); ?>" class="btn btn-sm btn-info">
                            <i class="fa fa-refresh" aria-hidden="true"></i>
                          </a>
                  <?php
                   } ?>
                ...
                <td>
                    <a href="<?php echo site_url('admin/Gallary_c/edit_gallary/'.$id);?>" class="btn btn-outline-info btn-sm"> Edit </a>
                    <br/>
                   <a href="<?php echo site_url('admin/Gallary_c/delete_gallary/'.$id);?>" class="btn btn-outline-danger btn-sm"> Del </a>
                </td>
              </tr>
              <?php
              $gallery_id++;
